...
export function EditorUi (editor, container, lightbox) {
  ...
  if (this.toolbar != null) {
    var update = mxUtils.bind(this, function () {
      var currentVertexStyle = graph.currentVertexStyle || {}
      var ff = currentVertexStyle['fontFamily'] || 'Helvetica';
      var fs = String(currentVertexStyle['fontSize'] || '12');
...
EditorUi.prototype.createDivs = function () {
  ...
  this.toolbarContainer = this.createDiv('geToolbarContainer');//顶部工具栏
  this.toolbarContainer.style.left = '0px';
  this.toolbarContainer.style.right = '0px';

  this.sidebarContainer = this.createDiv('geSidebarContainer');//侧边栏
  this.sidebarContainer.style.left = '0px';

  this.formatContainer = this.createDiv('geSidebarContainer geFormatContainer');//右侧格式侧边栏
  this.formatContainer.style.right = '0px';
  this.formatContainer.style.zIndex = '1';

  this.diagramContainer = this.createDiv('geDiagramContainer');//绘图区域
  this.diagramContainer.style.right = ((this.format != null) ? this.formatWidth : 0) + 'px';

  this.footerContainer = this.createDiv('geFooterContainer');//底部区域
  this.footerContainer.style.left = '0px';
  this.footerContainer.style.right = '0px';
  this.footerContainer.style.bottom = '0px';
  this.footerContainer.style.zIndex = mxPopupMenu.prototype.zIndex - 2;

  this.hsplit = this.createDiv('geHsplit');//收缩条
