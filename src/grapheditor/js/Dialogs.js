 ...
 */
export function AboutDialog (editorUi) {
  var div = document.createElement('div');
 ...
 */
export function FilenameDialog (editorUi, filename, buttonText, fn, label, validateFn, content, helpLink, closeOnBtn, cancelFn, hints) {
 ...
 */
export function TextareaDialog (editorUi, title, url, fn, cancelFn, cancelTitle, w, h, addButtons, noHide, noWrap, applyTitle) {
  w = (w != null) ? w : 300;
  h = (h != null) ? h : 120;
 ...
 */
export function EditDataDialog (ui, cell) {
  var div = document.createElement('div');
 ...
 */
export function LinkDialog (editorUi, initialValue, btnLabel, fn) {
  var div = document.createElement('div');
