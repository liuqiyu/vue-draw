...
import { FilenameDialog, EditDataDialog } from '@/grapheditor/js/Dialogs'
 ...
 * 
 */
export var ErrorDialog = function (editorUi, title, message, buttonText, fn, retry, buttonText2, fn2, hide, buttonText3, fn3) {
