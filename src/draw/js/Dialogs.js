...
export var StorageDialog = function (editorUi, fn, rowLimit) {
  ...
  function addLogo (img, title, mode, clientName, labels, clientFn) {
    ...
    if (img != null) {
      ...
      logo.setAttribute('src', require('@/draw/images' + img));
  ...
  if (isLocalStorage && (urlParams['browser'] == '1' || urlParams['offline'] == '1')) {
    addLogo('/osa_database.png', mxResources.get('browser'), App.MODE_BROWSER);
  }
 ...
 */
export var SplashDialog = function (editorUi) {
  var div = document.createElement('div');
  div.style.textAlign = 'center';
  ...
  logo.src = require('@/draw/images/osa_drive-harddisk.png');
 ...
 */
export var EmbedDialog = function (editorUi, result, timeout, ignoreSize, previewFn, title) {
  var div = document.createElement('div');
  var maxSize = 500000;
  var maxFbSize = 51200;
 ...
 */
export var GoogleSitesDialog = function (editorUi, publicUrl) {
  var div = document.createElement('div');
 ...
 */
export var CreateGraphDialog = function (editorUi, title, type) {
  var div = document.createElement('div');
 ...
 * Constructs a new parse dialog.
 */
export var BackgroundImageDialog = function (editorUi, applyFn) {
  var div = document.createElement('div');
  div.style.whiteSpace = 'nowrap';
 ...
 * Constructs a new parse dialog.
 */
export var ParseDialog = function (editorUi, title, defaultType) {
 ...
 */
export var NewDialog = function (editorUi, compact, showName, callback, createOnly, cancelCallback,
  ...
  if (!compact) {
    ...
    async function loadDrawioTemplates () {
 ...
 */
export var CreateDialog = function (editorUi, title, createFn, cancelFn, dlgTitle, btnLabel, overrideExtension,
  ...
  function addLogo (img, title, mode, clientName) {
    ...
    var logo = document.createElement('img');
    logo.src = require('@/draw/images' + img);
    logo.setAttribute('border', '0');
    logo.setAttribute('align', 'absmiddle');
    logo.style.width = '60px';
    logo.style.height = '60px';
 ...
 */
export var PopupDialog = function (editorUi, url, pre, fallback, hideDialog) {
 ...
 */
export var ImageDialog = function (editorUi, title, initialValue, fn, ignoreExisting, convertDataUri) {
  ...
  if (Graph.fileSupport) {
    ...
    div.style.backgroundImage = 'url(\'' + '/droptarget.png\')';
 ...
 */
export var LinkDialog = function (editorUi, initialValue, btnLabel, fn, showPages) {
  var div = document.createElement('div');
  ...
  if (typeof (google) != 'undefined' && typeof (google.picker) != 'undefined' && editorUi.drive != null) {
    addButton('/google-drive-logo.svg', mxResources.get('googlePlus'), function () {
      if (editorUi.spinner.spin(document.body, mxResources.get('authorizing'))) {
        editorUi.drive.checkToken(mxUtils.bind(this, function () {
          editorUi.spinner.stop();
  ...
  if (typeof (Dropbox) != 'undefined' && typeof (Dropbox.choose) != 'undefined') {
    addButton('/dropbox-logo.svg', mxResources.get('dropbox'), function () {
  ...
  if (editorUi.oneDrive != null) {
    addButton('/onedrive-logo.svg', mxResources.get('oneDrive'), function () {
  ...
  if (editorUi.gitHub != null) {
    addButton('/github-logo.svg', mxResources.get('github'), function () {
 ...
 */
export var AboutDialog = function (editorUi) {
  var div = document.createElement('div');
  ...
  if (mxClient.IS_SVG) {
    ...
    img.setAttribute('src', '/drawlogo-text-bottom.svg');
  }
  else {
    ...
    img.setAttribute('src', '/logo-flat.png');
  }
 ...
 * Constructs a new about dialog
 */
export var FeedbackDialog = function (editorUi) {
  var div = document.createElement('div');
 ...
 */
export var RevisionDialog = function (editorUi, revs, restoreFn) {
  var div = document.createElement('div');
 ...
 * Constructs a new revision dialog
 */
export var DraftDialog = function (editorUi, title, xml, editFn, discardFn, editLabel, discardLabel, ignoreFn) {
  var div = document.createElement('div');
 ...
 * 
 */
export var FindWindow = function (ui, x, y, w, h) {
 ...
 * 
 */
export var TagsWindow = function (editorUi, x, y, w, h) {
  var graph = editorUi.editor.graph;
 ...
 */
export var AuthDialog = function (editorUi, peer, showRememberOption, fn) {
  var div = document.createElement('div');
  div.style.textAlign = 'center';
...
export var MoreShapesDialog = function (editorUi, expanded, entries) {
...
export var PluginsDialog = function (editorUi) {
  var div = document.createElement('div');
  var inner = document.createElement('div');
...
export var CropImageDialog = function (editorUi, image, fn) {
  var div = document.createElement('div');
...
export var EditGeometryDialog = function (editorUi, vertices) {
  var graph = editorUi.editor.graph;
 ...
 * Constructs a new dialog for creating files from templates.
 */
export var LibraryDialog = function (editorUi, name, library, initialImages, file, mode) {
  var images = [];
  var graph = editorUi.editor.graph;
  var outer = document.createElement('div');
  outer.style.height = '100%';
 ...
 */
export var EditShapeDialog = function (editorUi, cell, title, w, h) {
  w = (w != null) ? w : 300;
  h = (h != null) ? h : 120;
  var row, td;
...
export var CustomDialog = function (editorUi, content, okFn, cancelFn, okButtonText, helpLink, buttonsContent, hideCancel) {
  var div = document.createElement('div');
...
export var TemplatesDialog = function () {
  var dialogSkeleton =
 ...
 */
export var BtnDialog = function (editorUi, peer, btnLbl, fn) {
  var div = document.createElement('div');
  div.style.textAlign = 'center';
