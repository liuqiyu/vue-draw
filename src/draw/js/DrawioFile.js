...
export var DrawioFile = function (ui, data) {
        ...
        if (this.lastWarned == null) {
          ...
          this.ui.showError(mxResources.get('unsavedChanges'), msg, mxResources.get('ignore'),
            mxUtils.bind(this, function () {
              ...
              this.ui.hideDialog();
              EditorUi.logEvent({
                category: 'IGNORE-WARN-SAVE-FILE-' + this.getHash() +
              ...
              this.ui.actions.get((this.ui.mode == null || !this.isEditable()) ?
                'saveAs' : 'save').funct();
              EditorUi.logEvent({
                category: 'SAVE-WARN-SAVE-FILE-' + this.getHash() +
...
DrawioFile.prototype.destroy = function () {
  ...
  try {
    if (!this.ui.isOffline() && this.reportEnabled &&
      ...
      EditorUi.logEvent({
        category: DrawioFile.SYNC + '-DESTROY-FILE-' + DrawioFile.SYNC,
